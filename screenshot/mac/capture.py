...
from .window import gen_window_ids, WINDOW_OPTIONS, USER_OPTS_STR
...
def run(application_name: str,
    ...
    try:
        if all_windows:
            ...
            filename = screenshot_window(application_name, title, filename, window_selection_options, options)
            print(filename)
